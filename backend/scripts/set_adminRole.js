...
async function main() {
  ...
  const I4TKnetworkabi=  [
    ...
    },
    {
      ...
      "outputs": [
        {
          "internalType": "enum I4TKNetwork.Status",
          "name": "",
          "type": "uint8"
        }
      ],
  ...
  //const deployer = new ethers.Wallet(process.env.PRIVATE_KEY, hre);
  ...
  const tokendeployed = new hre.ethers.Contract("0x431Dc5f0176Cf579Ce2D9A445B953fa9FC75f036", I4TKdocTokenABI, deployer);
  const contractdeployed = new hre.ethers.Contract("0x920800f339FA7b66342368D7ecAf1eEDcE40305E", I4TKnetworkabi, deployer);
  ...
  const tx = await tokendeployed.grantRole(minterRole,"0x920800f339FA7b66342368D7ecAf1eEDcE40305E");
