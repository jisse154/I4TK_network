...
const ProposeForm = () => {
  ...
  const {
    data: lastTokenId,
    isSuccess: isLastTokenIdSuccess,
  ...
  const {
    ...
    args: [
      newTokenId,
      tokenMetadata.tokenCID,
      tokenMetadata.tokenTitle,
      tokenMetadata.tokenAuthors,
      tokenMetadata.tokenDescription,
      tokenMetadata.tokenProgramme,
      tokenMetadata.tokenCategories,
    ],
    account: address,
  });
    ...
    <form className="m-5">
      <div className="space-y-6">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">Please enter all informations needed:</p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <span className="text-sm italic font-small">enter the list of authors separated by a comma</span>
              <div className="mt-2">
                <input
                  type="text"
                  name="tokenAuthors"
