...
//https://codesandbox.io/s/github/holtzy/react-graph-gallery/tree/main/viz/SankeyDiagramBasic?from-embed=&file=/Sankey.tsx
...
const SankeyChart = () => {
    ...
    const energy = [{ source: "Agricultural 'waste'", target: "Bio-conversion", value: 124.729 },
    ...
    const nodes = Array.from(new Set(energy.flatMap(l => [l.source, l.target])), name => ({ name, category: name.replace(/ .*/, "") }));
