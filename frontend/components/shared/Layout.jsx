                ...
                <>
                    <section className="overflow-hidden min-h-full">
                        ...
                        <div className="navbar-menu z-50 fixed top-0 hidden flex xl:flex flex-col justify-between bg-gray-900 max-w-xs w-9/12 h-full overflow-y-auto">
                                        ...
                                        <li>
                                            <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/valide">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-white font-medium text-base">Validate contents</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                            ...
                            <div className="relative bg-gray-900">
                                ...
                                <ul className="px-4 pb-28">
                                    <li>
                                        <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/account">
                                            <div className="flex items-center">
                                                <svg className="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p className="text-white font-medium text-base">My Accounts</p>
                                            </div>
                                        </a>
                                    </li>
                                    { true ? (
                        ...
                        <div className="xl:ml-80">
                            <section className="p-8 background-image: url('../public/images/banner_I4TK.jpg') bg-[url('../public/images/banner_I4TK.jpg')] background-position: center bg-cover">
