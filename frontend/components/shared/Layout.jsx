            ...
            {domLoaded && (
                <>
                    <section className="overflow-hidden min-h-full">
                        <div className="relative z-50 flex items-center justify-between xl:hidden bg-gray-900 px-8 py-5 -mx-3">
                            <div className="w-auto px-3">
                                <a className="block max-w-max" href="#">
                                    <img src="/images/Sans titre-2.jpg" alt=""></img>
                                </a>
                            </div>
                            <div className="w-auto px-3">
                                <button className="navbar-burger self-center ml-auto block xl:hidden">
                                    <svg width="35" height="35" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path className="text-gray-400" d="M7 12H25C25.2652 12 25.5196 11.8946 25.7071 11.7071C25.8946 11.5196 26 11.2652 26 11C26 10.7348 25.8946 10.4804 25.7071 10.2929C25.5196 10.1054 25.2652 10 25 10H7C6.73478 10 6.48043 10.1054 6.29289 10.2929C6.10536 10.4804 6 10.7348 6 11C6 11.2652 6.10536 11.5196 6.29289 11.7071C6.48043 11.8946 6.73478 12 7 12ZM25 15H7C6.73478 15 6.48043 15.1054 6.29289 15.2929C6.10536 15.4804 6 15.7348 6 16C6 16.2652 6.10536 16.5196 6.29289 16.7071C6.48043 16.8946 6.73478 17 7 17H25C25.2652 17 25.5196 16.8946 25.7071 16.7071C25.8946 16.5196 26 16.2652 26 16C26 15.7348 25.8946 15.4804 25.7071 15.2929C25.5196 15.1054 25.2652 15 25 15ZM25 20H7C6.73478 20 6.48043 20.1054 6.29289 20.2929C6.10536 20.4804 6 20.7348 6 21C6 21.2652 6.10536 21.5196 6.29289 21.7071C6.48043 21.8946 6.73478 22 7 22H25C25.2652 22 25.5196 21.8946 25.7071 21.7071C25.8946 21.5196 26 21.2652 26 21C26 20.7348 25.8946 20.4804 25.7071 20.2929C25.5196 20.1054 25.2652 20 25 20Z" fill="currentColor"></path>
                                    </svg>
                                </button>
                            </div>
                        </div>
                        <div className="navbar-menu z-50 fixed top-0 hidden flex xl:flex flex-col justify-between bg-gray-900 max-w-xs w-9/12 h-full overflow-y-auto">
                            <div className="navbar-backdrop fixed xl:hidden inset-0 bg-gray-900 opacity-60"></div>
                            <div className="relative bg-gray-900">
                                <div className="fixed -left-4 p-8 pl-12 max-w-xs w-9/12 z-50 bg-gray-900">
                                    <a className="block max-w-max" href="/">
                                        <img src="/images/Sans titre-2.jpg" alt=""></img>
                                    </a>
                                </div>
                                <div className="mt-28">
                                    <p className="px-8 mb-2 text-xs font-medium text-gray-500 uppercase">Main menu</p>
                                    <ul className="px-4 mb-8">
                                        <li>
                                            <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/library">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-white font-medium text-base">I4TK Library</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/valide">
                                                <div className="flex items-center">
                                                    <svg className="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p className="text-white font-medium text-base">Validate</p>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/contribute/propose">
                                                <div className="flex items-center">
                                                    <svg className="mr-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <p className="text-white font-medium text-base">Contribute</p>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <div className="relative bg-gray-900">
                                <p className="px-8 mb-2 text-xs font-medium text-gray-500 uppercase">Settings</p>
                                        ...
                                        <li>
                                            <a className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md" href="/admin">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-white font-medium text-base">Administration</p>
                                                </div>
                                            </a>
                                        </li>
                                    ):(<></>)} 
                                </ul>
                                <div className="fixed bottom-0 -left-4 max-w-xs w-full flex flex-wrap items-center p-6 pl-10 justify-between bg-gray-900">
                                    <div className="w-auto">
                                        <div className="flex flex-wrap -mx-2">
                                            <div className="w-auto p-2">
                                                <h2 className="text-sm font-semibold text-white">John Doe</h2>
                                                <p className="text-sm font-medium text-gray-500">johndoe@flex.co</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="w-auto">
                        ...
                        <div className="xl:ml-80">
                            <section className="p-8 background-image: url('../public/images/banner_I4TK.jpg') bg-[url('../public/images/banner_I4TK.jpg')] background-position: center">
                                <div className="flex flex-wrap items-center -m-2">
                                    <div className="w-full md:w-1/2 p-2">
                                        <h2 className="mb-2 font-semibold text-white text-3xl">I4T Knowledge Network</h2>
                                        <p className="text-gray-500 font-medium">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                                    <div className="w-full md:w-1/2 p-2">
                            ...
                            <section className="bg-white background-image: url('flex-ui-assets/elements/pattern-white.svg') background-position: center">
                                <div className="container px-4 mx-auto"></div>
                                <div className="border-b border-gray-100"></div>
                                <div className="container px-4 mx-auto">
                                    <p className="py-10 md:pb-20 text-lg md:text-xl text-gray-400 font-medium text-center">© 2024 I4TK network . All rights reserved.</p>
                                </div>
                            </section>
                        </div>
                    </section>
