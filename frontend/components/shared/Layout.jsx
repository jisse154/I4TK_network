...
const Layout = ({ children }) => {
  ...
  const { address, profile } = UseAppContext();
              ...
              <div className="relative bg-gray-900">
                ...
                <div className="mt-28">
                  ...
                  <ul className="px-4 mb-8">
                    <li>
                      <a
                        className="p-3 py-4 flex items-center justify-between text-gray-600 hover:text-green-500 hover:bg-gray-800 rounded-md"
                        href="/library"
                      >
            ...
            <div className="xl:ml-80">
              ...
              <section className="bg-white background-image: url('flex-ui-assets/elements/pattern-white.svg') background-position: center">
                ...
                <div className="container px-4 mx-auto">
                  <p className="py-10 md:pb-20 text-lg md:text-xl text-gray-400 font-medium text-center">
                    © 2024 I4TK network . All rights reserved.
                  </p>
                </div>
              </section>
            </div>
