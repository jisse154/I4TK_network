            ...
            <div className="w-full md:w-3/4 px-4 mb-8">
                ...
                <div className="mb-4">
                    {contentObj.tokenURIJson.properties.category.map((c, index) => {
                        return (
                            <a key={index} className="inline-block py-1 px-3 text-xs leading-5 text-green-500 hover:text-green-600 font-medium  bg-green-100 hover:bg-green-200 rounded-full shadow-sm mr-5 " href="#">{c}</a>
                        );
                    })}
                ...
                <div className="flex justify-between">
                    ...
                    <Button onClick={valide} className=" w-1/4 text-white bg-gray-500 ">Validate</Button>
                </div>
